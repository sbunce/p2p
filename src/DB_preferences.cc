...
boost::mutex DB_preferences::Mutex;
...
unsigned DB_preferences::get_client_connections()
{
...
std::string DB_preferences::get_download_directory()
{
...
unsigned DB_preferences::get_download_rate()
{
...
unsigned DB_preferences::get_server_connections()
{
...
std::string DB_preferences::get_share_directory()
{
...
unsigned DB_preferences::get_upload_rate()
{
...
void DB_preferences::set_client_connections(const unsigned & connections)
{
...
void DB_preferences::set_download_directory(const std::string & download_directory)
{
	std::ostringstream ss;
...
void DB_preferences::set_download_rate(const unsigned & rate)
{
	std::stringstream ss;
...
void DB_preferences::set_server_connections(const unsigned & connections)
{
	std::ostringstream ss;
...
void DB_preferences::set_share_directory(const std::string & share_directory)
{
	std::ostringstream ss;
...
void DB_preferences::set_upload_rate(const unsigned & rate)
{
	std::stringstream ss;
