#ifndef H_CPPROTO_MESSAGE
#define H_CPPROTO_MESSAGE
...
CPPROTO_MESSAGE_BEGIN(nested_message, 0)
	CPPROTO_FIELD(cpproto::ASCII<0>, name)
	CPPROTO_FIELD(cpproto::list<cpproto::ASCII<5> >, contact_list)
CPPROTO_MESSAGE_END
*/
#define CPPROTO_MESSAGE_BEGIN(m_class, field_ID) \
