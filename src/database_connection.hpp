...
public:
	...
	//debug functions
	static unsigned open_speed()
	{
		return Open.speed();
	}
	static unsigned query_speed()
	{
		return Query.speed();
	}
...
private:
	...
	*/
	...
	static speed_calculator Open;  //database open/second
	static speed_calculator Query; //queries per second
