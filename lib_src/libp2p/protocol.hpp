...
const unsigned char CLOSE_SLOT = static_cast<unsigned char>(1);
const unsigned CLOSE_SLOT_SIZE = 2;
const unsigned char ERROR = static_cast<unsigned char>(2);
const unsigned ERROR_SIZE = 1;
const unsigned char REQUEST_SLOT = static_cast<unsigned char>(3);
const unsigned REQUEST_SLOT_SIZE = 21;
const unsigned char REQUEST_SLOT_FAILED = static_cast<unsigned char>(4);
const unsigned REQUEST_SLOT_FAILED_SIZE = 21;
const unsigned char REQUEST_BLOCK_HASH_TREE = static_cast<unsigned char>(5);
const unsigned REQUEST_BLOCK_HASH_TREE_SIZE = 6;
const unsigned char REQUEST_BLOCK_FILE = static_cast<unsigned char>(6);
const unsigned REQUEST_BLOCK_FILE_SIZE = 6;
const unsigned char SLOT_ID = static_cast<unsigned char>(7);
